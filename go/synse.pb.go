...
func (PluginHealth_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{3, 0}
}
...
func (WriteResponse_WriteStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{11, 0}
}
...
func (WriteResponse_WriteState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{11, 1}
}
...
type DeviceFilter struct {
	// The rack identifier.
	Rack string `protobuf:"bytes,1,opt,name=rack,proto3" json:"rack,omitempty"`
...
func (*DeviceFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{0}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{1}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{2}
}
...
type PluginHealth struct {
	...
	Status PluginHealth_Status `protobuf:"varint,2,opt,name=status,proto3,enum=synse.PluginHealth_Status" json:"status,omitempty"`
...
func (*PluginHealth) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{3}
}
...
func (*HealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{4}
}
...
func (*DeviceCapability) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{5}
}
...
type Metadata struct {
	...
	Vcs                  string       `protobuf:"bytes,5,opt,name=vcs,proto3" json:"vcs,omitempty"`
...
func (*Metadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{6}
}
...
func (*VersionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{7}
}
...
func (*Reading) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{8}
}
...
type Reading_Float32Value struct {
	Float32Value float32 `protobuf:"fixed32,7,opt,name=float32_value,json=float32Value,proto3,oneof"`
}
type Reading_Float64Value struct {
	Float64Value float64 `protobuf:"fixed64,8,opt,name=float64_value,json=float64Value,proto3,oneof"`
}
...
type Reading_Uint32Value struct {
	Uint32Value uint32 `protobuf:"varint,12,opt,name=uint32_value,json=uint32Value,proto3,oneof"`
}
type Reading_Uint64Value struct {
	Uint64Value uint64 `protobuf:"varint,13,opt,name=uint64_value,json=uint64Value,proto3,oneof"`
}
...
type WriteInfo struct {
	...
	DeviceFilter *DeviceFilter `protobuf:"bytes,1,opt,name=deviceFilter,proto3" json:"deviceFilter,omitempty"`
	// The data to write to the device.
	Data                 []*WriteData `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (*WriteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{9}
}
...
func (*WriteData) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{10}
}
...
type WriteResponse struct {
	...
	Status WriteResponse_WriteStatus `protobuf:"varint,4,opt,name=status,proto3,enum=synse.WriteResponse_WriteStatus" json:"status,omitempty"`
	// The state of the transaction. This describes the so called "health"
	// of the transaction.
	State WriteResponse_WriteState `protobuf:"varint,5,opt,name=state,proto3,enum=synse.WriteResponse_WriteState" json:"state,omitempty"`
...
func (*WriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{11}
}
...
func (*TransactionFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{12}
}
...
type Transactions struct {
	...
	Transactions         map[string]*WriteData `protobuf:"bytes,1,rep,name=transactions,proto3" json:"transactions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*Transactions) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{13}
}
...
type Device struct {
	...
	// for don't care.
	SortOrdinal int32 `protobuf:"varint,8,opt,name=sortOrdinal,proto3" json:"sortOrdinal,omitempty"`
	...
	Output               []*Output `protobuf:"bytes,9,rep,name=output,proto3" json:"output,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (*Device) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{14}
}
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{15}
}
...
type Output struct {
	...
	ScalingFactor float64 `protobuf:"fixed64,4,opt,name=scalingFactor,proto3" json:"scalingFactor,omitempty"`
...
func (*Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{16}
}
...
func (*Unit) Descriptor() ([]byte, []int) {
	return fileDescriptor_synse_f9a819781da3c403, []int{17}
}
...
func (c *pluginClient) Test(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/synse.Plugin/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Version(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*VersionInfo, error) {
	out := new(VersionInfo)
	err := c.cc.Invoke(ctx, "/synse.Plugin/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Health(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PluginHealth, error) {
	...
	err := c.cc.Invoke(ctx, "/synse.Plugin/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Metainfo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Metadata, error) {
	out := new(Metadata)
	err := c.cc.Invoke(ctx, "/synse.Plugin/Metainfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Capabilities(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Plugin_CapabilitiesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Plugin_serviceDesc.Streams[0], "/synse.Plugin/Capabilities", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Devices(ctx context.Context, in *DeviceFilter, opts ...grpc.CallOption) (Plugin_DevicesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Plugin_serviceDesc.Streams[1], "/synse.Plugin/Devices", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Read(ctx context.Context, in *DeviceFilter, opts ...grpc.CallOption) (Plugin_ReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Plugin_serviceDesc.Streams[2], "/synse.Plugin/Read", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Write(ctx context.Context, in *WriteInfo, opts ...grpc.CallOption) (*Transactions, error) {
	...
	err := c.cc.Invoke(ctx, "/synse.Plugin/Write", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Transaction(ctx context.Context, in *TransactionFilter, opts ...grpc.CallOption) (Plugin_TransactionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Plugin_serviceDesc.Streams[3], "/synse.Plugin/Transaction", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("synse.proto", fileDescriptor_synse_f9a819781da3c403) }

var fileDescriptor_synse_f9a819781da3c403 = []byte{
	...
	,
}
