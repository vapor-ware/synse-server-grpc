...
class V3Plugin(object):
    ...
    def Devices(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/Devices',
            synse__pb2.V3DeviceSelector.SerializeToString,
            synse__pb2.V3Device.FromString,
    ...
    def Health(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synse.V3Plugin/Health',
            synse__pb2.Empty.SerializeToString,
            synse__pb2.V3Health.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Metadata(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synse.V3Plugin/Metadata',
            synse__pb2.Empty.SerializeToString,
            synse__pb2.V3Metadata.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Read(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/Read',
            synse__pb2.V3ReadRequest.SerializeToString,
            synse__pb2.V3Reading.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReadCache(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/ReadCache',
            synse__pb2.V3Bounds.SerializeToString,
            synse__pb2.V3Reading.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReadStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/ReadStream',
            synse__pb2.V3StreamRequest.SerializeToString,
            synse__pb2.V3Reading.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Test(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synse.V3Plugin/Test',
            synse__pb2.Empty.SerializeToString,
            synse__pb2.V3TestStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Transaction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synse.V3Plugin/Transaction',
            synse__pb2.V3TransactionSelector.SerializeToString,
            synse__pb2.V3TransactionStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Transactions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/Transactions',
            synse__pb2.Empty.SerializeToString,
            synse__pb2.V3TransactionStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Version(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synse.V3Plugin/Version',
            synse__pb2.Empty.SerializeToString,
            synse__pb2.V3Version.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def WriteAsync(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/WriteAsync',
            synse__pb2.V3WritePayload.SerializeToString,
            synse__pb2.V3WriteTransaction.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def WriteSync(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/synse.V3Plugin/WriteSync',
            synse__pb2.V3WritePayload.SerializeToString,
            synse__pb2.V3TransactionStatus.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
